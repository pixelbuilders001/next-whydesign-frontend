          ...
          <div className="relative group order-2 lg:order-1">
            <div className="relative overflow-hidden rounded-3xl shadow-2xl">
              ...
              <div className="absolute bottom-8 left-8 text-white">
                <p className="text-xl font-medium mb-2">Join 10,000+ Fashion Designers</p>
                <p className="text-stone-200 font-light">Start your creative journey today</p>
              </div>
            </div>
          </div>
          ...
          <div className="space-y-10 order-1 lg:order-2 ">
            <div className='text-center'>
              ...
              <p className="text-xl text-gray-600 leading-relaxed font-light">
                Get personalized guidance from industry experts. Share your details 
                and we'll create a custom roadmap for your fashion career.
              </p>
            </div>
